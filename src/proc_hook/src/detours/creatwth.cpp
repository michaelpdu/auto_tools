                                        ...
                                        PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINEA pfCreateProcessInternalA)
{
    ...
    if (pfCreateProcessInternalA == NULL) {
        return FALSE;
    }

    if (!pfCreateProcessInternalA(
        hToken,
        lpApplicationName,
        lpCommandLine,
        lpProcessAttributes,
                                        ...
                                        PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINEW pfCreateProcessInternalW)
{
    ...
    if (pfCreateProcessInternalW == NULL) {
        DETOUR_TRACE(("CreateProcessInternalWithDllW is NULL"));
        return FALSE;
    }

    if (!pfCreateProcessInternalW(
        hToken,
        lpApplicationName,
        lpCommandLine,
        lpProcessAttributes,
    ...
    DETOUR_TRACE(("CreateProcessInternalWithDllW(), DetourUpdateProcessWithDll"));
    LPCSTR rlpDlls[2];
    DWORD nDlls = 0;
    if (lpDllName != NULL) {
        rlpDlls[nDlls++] = lpDllName;
