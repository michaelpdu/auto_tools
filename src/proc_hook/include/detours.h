...
typedef BOOL (WINAPI *PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINEA)
    (HANDLE hToken,
    LPCSTR lpApplicationName,
    LPSTR lpCommandLine,
    LPSECURITY_ATTRIBUTES lpProcessAttributes,
...
typedef NTSTATUS (WINAPI * PDETOUR_RTL_DECOMPRESS_BUFFER_ROUTINE)(
...
BOOL WINAPI DetourCreateProcessInternalWithDllA(HANDLE hToken,
                                                LPCSTR lpApplicationName,
                                                __in_z LPSTR lpCommandLine,
                                                LPSECURITY_ATTRIBUTES lpProcessAttributes,
                                                LPSECURITY_ATTRIBUTES lpThreadAttributes,
                                                ...
                                                PHANDLE hNewToken,
                                                LPCSTR lpDllName,
                                                PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINEA pfCreateProcessInternalA);

BOOL WINAPI DetourCreateProcessInternalWithDllW(HANDLE hToken,
                                                LPCWSTR lpApplicationName,
                                                __in_z LPWSTR lpCommandLine,
                                                LPSECURITY_ATTRIBUTES lpProcessAttributes,
                                                LPSECURITY_ATTRIBUTES lpThreadAttributes,
                                                ...
                                                PHANDLE hNewToken,
                                                LPCSTR lpDllName,
                                                PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINEW pfCreateProcessInternalW);


#ifdef UNICODE
#define DetourCreateProcessWithDll      DetourCreateProcessWithDllW
#define PDETOUR_CREATE_PROCESS_ROUTINE  PDETOUR_CREATE_PROCESS_ROUTINEW
#define DetourCreateProcessInternalWithDll       DetourCreateProcessInternalWithDllW
#define PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINE  PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINEW

#else
#define DetourCreateProcessWithDll      DetourCreateProcessWithDllA
#define PDETOUR_CREATE_PROCESS_ROUTINE  PDETOUR_CREATE_PROCESS_ROUTINEA
#define DetourCreateProcessInternalWithDll       DetourCreateProcessInternalWithDllA
#define PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINE  PDETOUR_CREATE_PROCESS_INTERNAL_ROUTINEA
