...
class AutoVerifier:
    ...
    def __init__(self):
        ...
        self.file_result_.write("file-path,file-type,gen-raw,decision,rules,decision-with-browser,rules-with-browser,number-of-embedded,decision-embedded,rules-embedded\n")
