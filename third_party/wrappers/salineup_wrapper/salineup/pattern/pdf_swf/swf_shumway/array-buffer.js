...
if (!inBrowser && !useNativeArrayBuffer) { 
  (function () {
    "use strict";
    ...
    //if (!ArrayBuffer) {
        (function () {
            ...
            Int8Array = makeTypedArrayConstructor(1, packInt8, unpackInt8);
            Uint8Array = makeTypedArrayConstructor(1, packUint8, unpackUint8);
            Int16Array = makeTypedArrayConstructor(2, packInt16, unpackInt16);
            Uint16Array = makeTypedArrayConstructor(2, packUint16, unpackUint16);
            Int32Array = makeTypedArrayConstructor(4, packInt32, unpackInt32);
            Uint32Array = makeTypedArrayConstructor(4, packUint32, unpackUint32);
            Float32Array = makeTypedArrayConstructor(4, packFloat32, unpackFloat32);
            Float64Array = makeTypedArrayConstructor(8, packFloat64, unpackFloat64);
