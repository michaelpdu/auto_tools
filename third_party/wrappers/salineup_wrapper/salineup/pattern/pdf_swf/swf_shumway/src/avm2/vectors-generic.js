...
var GenericVector = (function () {
  ...
  vector.prototype.asSetNumericProperty = function (i, v) {
    ...
    controller.vectorMonitor.setNumericProperty(v); 
    //if (v instanceof Object) {
    //    if (v instanceof ByteArray) {
    //        print("[HOOK] Vector.setNumericProperty["+i+"]=ByteArray");
    //    } else {
    //        print("[HOOK] Vector.setNumericProperty["+i+"]=Object");
    //    }
    //} else {
    //    print("[HOOK] Vector.setNumericProperty["+i+"]=notObject");
    //}
  };
