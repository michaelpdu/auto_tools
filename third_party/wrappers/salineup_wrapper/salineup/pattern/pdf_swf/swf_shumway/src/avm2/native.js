...
//        return cls;
  ...
  function ByteArrayClass(runtime, scope, instanceConstructor, baseClass) {
    var BA = function (args) { return ByteArray.call(this, args); };
    ...
    BAp.asSetNumericProperty = function (i, v) {
      if (g_isDoSwf == false){
        controller.byteArrayMonitor.indexSetter();
      }
      var len = i + 1;
    ...
    BAp.readUTFBytes = function readUTFBytes(length) {
      ...
      var ret = utf8encode(new Int8Array(this.a, pos, length));
      controller.byteArrayMonitor.readUTFBytes(ret);
      return ret;
    };
    ...
    c.native = {
      instance: {
        ...
        readMultiByte: BAp.readUTFBytes,
