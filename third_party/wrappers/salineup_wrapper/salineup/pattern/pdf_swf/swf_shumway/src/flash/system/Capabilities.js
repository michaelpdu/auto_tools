      ...
      static: {
        version: {
          get: function version() {
            TMSA_INFO("Access Capabilities.version");
            return 'Win 11,8,402,265';
          },
          enumerable: true
        },
        os: {
          get: function () {
            TMSA_INFO("Access Capabilities.os");
            return os;
          },
          enumerable: true
        },
        ...
        hasAccessibility: {
          get: function hasAccessibility() { // (void) -> Boolean
            TMSA_INFO("Access Capabilities.hasAccessibility");
        ...
        isDebugger: {
          get: function isDebugger() { // (void) -> Boolean
            TMSA_INFO("Access Capabilities.isDebugger");
            return false;
          }
        },
        screenResolutionX: {
        ...
        language: {
          get: function language() {
            TMSA_INFO("Access Capabilities.language");
        ...
        playerType: {
          get: function playerType() {
            TMSA_INFO("Access Capabilities.playerType");
